...
let HOST_URL = "https://mmi.unilim.fr/~zbalah3/R213/SAE2.03-Addem-Zbalah";//"http://mmi.unilim.fr/~????"; // CHANGE THIS TO MATCH YOUR CONFIG
...
let DataMovie = {};
 ...
 /**
     ...
     *
     * @param {string} category - The week parameter to be sent to the server.
     * @param {string} title - The day parameter to be sent to the server.
     ...
     */
DataMovie.request = async function(category, title){
    // fetch permet d'envoyer une requête HTTP à l'URL spécifiée. 
    // L'URL est construite en concaténant HOST_URL à "/server/script.php?direction=" et la valeur de la variable dir. 
    // L'URL finale dépend de la valeur de HOST_URL et de dir.
    let answer = await fetch(HOST_URL + "/server/script.php?todo=read&category=" + category + "&title=" + title);
